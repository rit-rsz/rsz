...
import math, sys
'''
Documentation for the sides catalog found at http://cesam.lam.fr/sides/data/Mock_cat_Bethermin2017.readme
'''
def ret_sides():
	a = time.time()
	data = pd.read_csv('/home/butler/SIDES_Bethermin2017.csv',usecols=[1,2,3,15,16,17])
