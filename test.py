...
x = c('a0370', saveplot=1, nsim=0, verbose=0, superplot=0, saveplot=1, cattype='PSW')
print('successful')
for i in range(100):
    x = c('a0370', saveplot=1, simmap=2, nsim=sim[i], verbose=0, superplot=0, saveplot=1, cattype='PSW')
